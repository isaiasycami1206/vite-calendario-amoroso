...
const rendererImagenes = (images: CalendarioData[], tamaño: number, screenType: string) => {
        ...
        <div className="d-flex justify-content-around align-items-center flex-wrap">
            {imagesUniques.map((ruta, index) => (
                <div
                    key={index}
                    className="column"
                    style={{ display: "flex", justifyContent: "space-between", flexDirection: "column", paddingBlock: 20, background: "lightgrey", borderRadius: 10 }}
                >
                    <img
                        src={ruta}
                        alt={`Imagen ${index + 1}`}
                        style={{ width: `${imageWidth}px`, height: `${imageHeight}px`, objectFit: 'cover', margin: '5px' }}
                    />
                    <FontAwesomeIcon
                        icon={faSolidHeart}
...
const CalendarioGeneralPage: React.FC = () => {
    ...
    const mensajeAnual = "Por un 2025 juntos mi amor ❤️";
        ...
        <div className="pt-5 pb-5">
            <div className="calendario-general">
                <Card className="p-3 shadow-sm">
                    ...
                    <div className="mb-4">
                        {rendererImagenes(calendariosPorAnio[anioActual] || [], calcularTamaño(calendarioSize), screenType)}
                    </div>
